...
# I chose to use Notebooks to move data between layers because they provide better control over Delta Lake features. Using Spark commands ensures that the Gold layer tables are always optimized and ready for the Power BI Direct Lake connection, which is faster than traditional Import methods.
