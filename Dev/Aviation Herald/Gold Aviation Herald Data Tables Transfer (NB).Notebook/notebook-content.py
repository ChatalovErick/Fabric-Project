...
for original_table_name in tables_to_transfer:
    try:
        ...
        clean_table_name = original_table_name.replace("Gold_", "")
...
# 4. Force-stop the session to free up capacity for other jobs/users
print("All tasks complete. Shutting down Spark session.")
