...
# # (1) Transfer Schedule data from the dbo schema to the Silver schema

# CELL ********************

from delta.tables import DeltaTable

source_table = "dbo.Silver_lufthansadata_germany_schedule"
target_table = "Silver.lufthansadata_germany_schedule"
...
if not spark.catalog.tableExists(target_table):
    ...
    join_condition = """
        ...
        target.ArrivalTime = updates.ArrivalTime AND 
